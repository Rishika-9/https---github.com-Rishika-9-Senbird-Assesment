                ...
                return (
                    <div key={channel.url} className="channel-list-item" >
                        <div
                            ...
                            <ChannelName members={channel.members} customType={channel.customType} name={channel.name}/>
...
const ChannelName = ({ members, customType, name }) => {
    ...
    return <>
        ...
        {customType && <span>({customType})</span>}
    </>
}
...
const loadChannels = async () => {
    try {
        ...
        const filteredChannels=channels.filter(channels => channels.customType && channels.customType!=='');
        return [filteredChannels, null];
    } catch (error) {
        return [null, error];
    }
}
...
const createChannel = async (channelName, userIdsToInvite) => {
    try {
        ...
        groupChannelParams.customType='Rishika'
